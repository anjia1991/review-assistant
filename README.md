...
- Aria can perform automatic update when internet access is available. To check for available update, selec# A.R.I.A. (Aria) - Your AI Research Assistant
...
t <em>Tools</em> from the top menu bar, and then click on <em>Addons</em>.
